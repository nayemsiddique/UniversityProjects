...
public class info {
    ...
    public info() {
     ...
     public info(String event_code, String event_name, LocalDate event_date, int event_fee, LocalDate reg_start, LocalDate reg_end) {
        this();
    ...
    public LocalDate getReg_start() {
        return reg_start;
    }

    public void setReg_start(LocalDate reg_start) {
        this.reg_start = reg_start;
    }
  ...
  @Override
    ...
    public ObservableList getQuota_type() {
        return quota_type;
    }

    public void setQuota_type(ObservableList quota_type) {
